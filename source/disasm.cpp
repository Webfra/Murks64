...
extern const std::array<std::string, 9615> c64disasm_en {
    ...
    ".,E4DA AD 86 02 LDA $0286       get the current colour code",
    ...
    ".,E621 20 91 E5 JSR $E591       find and set the pointers for the start of logical line",
